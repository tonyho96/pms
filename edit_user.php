		...
		<div class="col-md-12">
		  ...
		  <form method="post" action="user.php">
			  <div class="form-group">
				<input type="text" class="form-control" value="<?php echo $data["name"]; ?>" name="txtname" required><br>
				<input type="email" class="form-control" value="<?php echo $data["email"]; ?>" name="txtemail" required><br>
				<input type="password" class="form-control" placeholder="Password" name="txtpassword" required><br>
			  </div>
			  <div class="row">
				<div class="col-xs-4">
				  <button type="submit" class="btn btn-primary btn-block btn-flat" name="btn_update" value="<?php echo $_GET["id"]; ?>">Update</button>
				</div>
			  </div>
			</form>	
